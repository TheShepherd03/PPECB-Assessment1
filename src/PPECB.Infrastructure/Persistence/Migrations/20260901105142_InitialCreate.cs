...
namespace PPECB.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryCode = table.Column<string>(type: "varchar(6)", unicode: false, maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_OwnerId_ProductCode",
                table: "Products",
                columns: new[] { "OwnerId", "ProductCode" },
                unique: true);
        }
